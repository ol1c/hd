...
(
MAX([Room].[Number].Members, ([Measures].[Avg Visit Dutarion], [Date].[Date Hierarchy].CurrentMember))
- MIN([Room].[Number].Members, ([Measures].[Avg Visit Dutarion], [Date].[Date Hierarchy].CurrentMember))
)
