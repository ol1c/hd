...
(
MAX([Room].[Number].Members,
([Measures].[Avg Visit Dutarion], ParallelPeriod([Date].[Calendar].[Month], 1, [Date].[Calendar].CurrentMember))) - MIN([Room].[Number].Members,
([Measures].[Avg Visit Dutarion], ParallelPeriod([Date].[Calendar].[Month], 1, [Date].[Calendar].CurrentMember)))
)
